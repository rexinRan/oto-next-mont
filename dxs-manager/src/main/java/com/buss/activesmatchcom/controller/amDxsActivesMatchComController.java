...
@Scope("prototype")
@Controller
@RequestMapping("/amdxsActivesMatchComController")
public class amDxsActivesMatchComController extends BaseController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(amDxsActivesMatchComController.class);
	...
	public ModelAndView list(String activesId,String amId,HttpServletRequest request) {
		ModelAndView modelAndView=new ModelAndView("com/buss/activesmatchcom/amdxsActivesMatchComList");

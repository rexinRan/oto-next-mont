...
@Scope("prototype")
@Controller
@RequestMapping("/awdxsActivesMatchComController")
public class awDxsActivesMatchComController extends BaseController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(awDxsActivesMatchComController.class);
	...
	public ModelAndView list(String activesId,String amId,HttpServletRequest request) {
		ModelAndView modelAndView=new ModelAndView("com/buss/activesmatchcom/awdxsActivesMatchComList");

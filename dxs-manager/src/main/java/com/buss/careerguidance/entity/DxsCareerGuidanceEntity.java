...
public class DxsCareerGuidanceEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**职场引导分类id*/
	@Excel(name="职场引导分类id")
	...
	//大权添加与表dxs_career_guidance_catalog的多对一关联
	private DxsCareerGuidanceCatalogEntity dxsCareerGuidanceCatalogEntity;

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "cg_catelog_id", insertable=false, updatable = false)
	@NotFound(action= NotFoundAction.IGNORE)

	public DxsCareerGuidanceCatalogEntity getDxsCareerGuidanceCatalogEntity() {
		return dxsCareerGuidanceCatalogEntity;
	}

	public void setDxsCareerGuidanceCatalogEntity(DxsCareerGuidanceCatalogEntity dxsCareerGuidanceCatalogEntity) {
		this.dxsCareerGuidanceCatalogEntity = dxsCareerGuidanceCatalogEntity;
	}
}

...
import com.buss.employedcatalog.controller.DxsEmployedCatalogController;
...
@Scope("prototype")
@Controller
@RequestMapping("/dxsEmployedController")
public class DxsEmployedController extends BaseController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DxsEmployedController.class);
	...
	public ModelAndView list(String degId,String userId,HttpServletRequest request) {
		ModelAndView mod=new ModelAndView("com/buss/employed/dxsEmployedList");

		mod.addObject("degId",degId);
	...
	public void datagrid(DxsEmployedEntity dxsEmployed,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		try{
		//自定义追加查询条件
			cq.eq("degId",dxsEmployed.getDegId());
...
//				dxsEmployedService.delete(dxsEmployed);
	...
	public ModelAndView goAdd(String degId,String userId,DxsEmployedEntity dxsEmployed, HttpServletRequest req) {
		...
		ModelAndView modelAndView=new ModelAndView("com/buss/employed/dxsEmployed-add");
		modelAndView.addObject("degId",degId);
...
//		List<DxsUserEntity> DxsUserList=  systemService.findByProperty(DxsUserEntity.class,"rolecode","emp");
		...
		List<DxsUserEntity> DxsUserList=  systemService.findByExample(DxsUserEntity.class.getName(),dxsUser);
		req.setAttribute("DxsUserList",DxsUserList);
		return new ModelAndView("com/buss/employed/dxsEmployed-update");
	}

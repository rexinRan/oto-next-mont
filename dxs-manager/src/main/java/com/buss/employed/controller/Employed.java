...
public class Employed extends BaseController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(Employed.class);
	...
	public ModelAndView list(String degId,String userId,HttpServletRequest request) {
		ModelAndView mod=new ModelAndView("com/buss/employed/xsdxsEmployedList");
		return mod;
	}
...
//				dxsEmployedService.delete(dxsEmployed);
	...
	public ModelAndView goAdd(String degId,String userId,DxsEmployedEntity dxsEmployed, HttpServletRequest req) {
		...
		ModelAndView modelAndView=new ModelAndView("com/buss/employed/xsdxsEmployed-add");
...
//		List<DxsUserEntity> DxsUserList=  systemService.findByProperty(DxsUserEntity.class,"rolecode","emp");
		...
		List<DxsUserEntity> DxsUserList=  systemService.findByExample(DxsUserEntity.class.getName(),dxsUser);
		req.setAttribute("DxsUserList",DxsUserList);
		return new ModelAndView("com/buss/employed/xsdxsEmployed-update");
	}

package com.buss.file.service.impl;
...
public class DxsFileServiceImpl extends CommonServiceImpl implements DxsFileServiceI {
 	...
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((DxsFileEntity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((DxsFileEntity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((DxsFileEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public boolean doAddSql(DxsFileEntity t){
	 	return true;
 	}
 	/**
	 * 默认按钮-sql增强-更新操作
	 ...
	 * @return
	 */
 	public boolean doUpdateSql(DxsFileEntity t){
	 	return true;
 	}
 	/**
	 * 默认按钮-sql增强-删除操作
	 ...
	 * @return
	 */
 	public boolean doDelSql(DxsFileEntity t){
	 	return true;
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DxsFileEntity t){

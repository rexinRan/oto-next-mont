package com.buss.trainanserse.entity;
...
public class DxsTrainAnserseEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**结果*/
	@Excel(name="结果")
	...
	/**代表人物头像*/
	@Excel(name="代表人物头像")
	private java.lang.String symbolImg;
	/**代表人物语录*/
	@Excel(name="代表人物语录")
	...
	public java.lang.String getTtId(){
		return this.ttId;
	}
	 ...
	 */
	public void setTtId(java.lang.String ttId){
		this.ttId = ttId;
	}
	/**
	 *方法: 取得java.lang.String
	...
	public java.lang.String getSymbolImg(){
	 ...
	 */
	public void setSymbolImg(java.lang.String symbolImg){

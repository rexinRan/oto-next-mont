package com.buss.traincoursecatalog.entity;
 ...
 */
@Entity
@Table(name = "dxs_train_course_catalog", schema = "")
@SuppressWarnings("serial")
public class DxsTrainCourseCatalogEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**分类名称*/
	@Excel(name="分类名称")
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  分类显示名(预留)
	 */
	@Column(name ="CATALOG_DISPLAY_NAME",nullable=true,length=50)
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  分类显示名(预留)
	 */

package com.buss.trainonlinecourse.service.impl;
...
@Service("dxsTrainOnlineCourseService")
@Transactional
public class DxsTrainOnlineCourseServiceImpl extends CommonServiceImpl implements DxsTrainOnlineCourseServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((DxsTrainOnlineCourseEntity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((DxsTrainOnlineCourseEntity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((DxsTrainOnlineCourseEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public boolean doAddSql(DxsTrainOnlineCourseEntity t){
	 	return true;
 	}
 	/**
	 * 默认按钮-sql增强-更新操作
	 ...
	 * @return
	 */
 	public boolean doUpdateSql(DxsTrainOnlineCourseEntity t){
	 	return true;
 	}
 	/**
	 * 默认按钮-sql增强-删除操作
	 ...
	 * @return
	 */
 	public boolean doDelSql(DxsTrainOnlineCourseEntity t){
	 	return true;
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DxsTrainOnlineCourseEntity t){

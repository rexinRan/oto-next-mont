...
public class DxsTrainOutlineCourseUserEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**用户id*/
	@Excel(name="用户id")
	...
	private DxsTrainOutlineCourseEntity DxsTrainOutlineCourseEntity;
	/**
	...
	@NotFound(action= NotFoundAction.IGNORE)
	public com.buss.trainoutlinecourse.entity.DxsTrainOutlineCourseEntity getDxsTrainOutlineCourseEntity() {
		return DxsTrainOutlineCourseEntity;
	}

	public void setDxsTrainOutlineCourseEntity(com.buss.trainoutlinecourse.entity.DxsTrainOutlineCourseEntity dxsTrainOutlineCourseEntity) {
		DxsTrainOutlineCourseEntity = dxsTrainOutlineCourseEntity;
	}
}

...
public class Uploader1 {
	...
	public Uploader1(HttpServletRequest request) {
...
//	}
	...
	public void upload() throws Exception {
		...
		try {
			...
			CommonsMultipartFile orginFile = (CommonsMultipartFile) multipartRequest.getFile("upfile");

			this.originalName = orginFile.getOriginalFilename();
			if (!this.checkFileType(this.originalName)) {
				this.state = this.errorInfo.get("TYPE");
				return;
			}
			...
			String url = client.uploadFile(orginFile.getBytes(), ext);

...
//				$("#activeCatelogImg-queue").css("overflow","hidden").html("<img src=\"" + data + "\" />");
 ...
 <body>
  ...
  <form id="formobj" action="dxsAboutConcernController.do?doAdd" name="formobj" method="post">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
						  ...
						  <input id="concernImg" name="concernImg" type="text" class="form-control" value="" style="display: none">

...
//				 imageUrl: "E:/upload/",
 ...
 <body>
  ...
  <form id="formobj" action="dxsAboutDutyController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="imgFid" name="imgFid" type="text" class="form-control"  >--%>
			          ...
			          <div class="col-xs-3">
						  <textarea id="summary" class="form-control" rows="6" name="summary"></textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="articleFrom" name="articleFrom" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

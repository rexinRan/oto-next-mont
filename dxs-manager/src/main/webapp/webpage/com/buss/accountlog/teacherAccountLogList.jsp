...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="dxsAccountLogList" checkbox="true" fitColumns="false" title="" actionUrl="dxsAccountLogController.do?datagrid&userId=${userId}" idField="id" fit="true" queryMode="group">
   ...
   <%--<t:dgCol title="来源"  field="accountFrom"    queryMode="group"  width="120" formatterjs="DXS.accountFrom"></t:dgCol>--%>
   ...
   <t:dgToolBar title="查看" icon="icon-search" url="dxsAccountLogController.do?goUpdate" funname="detail"></t:dgToolBar>
      <t:dgToolBar title="返回" icon="icon-put" url="commonToPage.do?pack=account&path=dxsAccountList&id=3" funname="fanhui"></t:dgToolBar>
...
//     var DXS = {
//         accountFrom : function(value, row,index){
//             if (value == "1"){
//                 return "<span style='color:#ff3335'>现金购买</span>";
//             }else if (value == "0"){
//                 return "签到";
//             }else  {
//                 return value;

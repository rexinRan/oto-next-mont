...
<form id="formobj" action="dxsActiveCatelogController.do?doAdd" name="formobj" method="post">
		...
		<div class="con-wrapper" id="con-wrapper1" style="display: block;">
			<div class="row form-wrapper">
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						<input id="activeCatelogName" name="activeCatelogName" type="text" class="form-control"  >
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						<input id="activeCatelogDescribe" name="activeCatelogDescribe" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						<div id="_activeCatelogSort"></div>
						<input id="activeCatelogSort" name="activeCatelogSort" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

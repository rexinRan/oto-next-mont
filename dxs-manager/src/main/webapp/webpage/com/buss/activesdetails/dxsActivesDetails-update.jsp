<%@ page language="java" import="java.util.*" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" buffer="64kb" %>
...
//				$("#activeCatelogImg-queue").css("overflow","hidden").html("<img src=\"" + data + "\" />");
  ...
  window.onload=function()//用window的onload事件，窗体加载完毕的时候
  {
	  ...
	  if($('#_displayMenu').val()!=null){
		  $('#_displayMenu').val($('#displayMenu').val())
	  }
	  //单选按钮的回显
	  var obj = document.getElementsByName('paymentMethod');
	  var aa=$('#paymentMethod').val()
	  ...
	  var ob = document.getElementsByName('isCharge');
	  var bb=$('#isCharge').val()
 ...
 <body>
  ...
  <form id="formobj" action="dxsActivesDetailsController.do?doUpdate" name="formobj" method="post">
			<input type="hidden" id="btn_sub" class="btn_sub"/>
			<input type="hidden" name="id" value='${dxsActivesDetailsPage.id}' >
	        <input  name="activesId" type="hidden"  value='${dxsActivesDetailsPage.activesId}'>
			      ...
			      <div class="row form-wrapper">
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  ...
							  <input id="displayMenu"  type="hidden" class="form-control"  value='${dxsActivesPage.displayMenu}'>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  ...
							  <input id="isCharge" type="hidden" value="${dxsActivesPage.isCharge}">
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  <textarea id="costInclude" class="form-control" rows="6" name="costInclude">${dxsActivesDetailsPage.costInclude}</textarea>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
						  ...
						  <div class="col-xs-3">
							  <textarea id="costUninclude" class="form-control" rows="6" name="costUninclude">${dxsActivesDetailsPage.costUninclude}</textarea>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  <textarea id="visaNote" class="form-control" rows="6" name="visaNote">${dxsActivesDetailsPage.visaNote}</textarea>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
						  ...
						  <div class="col-xs-3">
							  <textarea id="preparation" class="form-control" rows="6" name="preparation">${dxsActivesDetailsPage.preparation}</textarea>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  ...
							  <input id="paymentMethod" type="hidden" class="form-control"  value='${dxsActivesDetailsPage.paymentMethod}'>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
						  ...
						  <div class="col-xs-3">
							  <input id="commonProblem" name="commonProblem" type="text" class="form-control"  value='${dxsActivesDetailsPage.commonProblem}'>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <%--</div>--%>
						  <%--<div class="col-xs-3">--%>
						  <%--<input id="img1Fid" name="img1Fid" type="text" class="form-control"  value='${dxsActivesDetailsPage.img1Fid}'>--%>
						  <%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
						  ...
						  <div class="col-xs-3">
							  <div id="_img1Url"></div>
							  <input id="img1Url" name="img1Url" type="text" class="form-control" value="${dxsActivesDetailsPage.img1Url}" style="display: none">
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <%--</div>--%>
						  <%--<div class="col-xs-3">--%>
						  <%--<input id="img2Fid" name="img2Fid" type="text" class="form-control"  value='${dxsActivesDetailsPage.img2Fid}'>--%>
						  <%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
						  ...
						  <div class="col-xs-3">
							  <div id="_img2Url"></div>
							  <input id="img2Url" name="img2Url" type="text" class="form-control" value="${dxsActivesDetailsPage.img2Url}" style="display: none">
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <%--</div>--%>
						  <%--<div class="col-xs-3">--%>
						  <%--<input id="img3Fid" name="img3Fid" type="text" class="form-control"  value='${dxsActivesDetailsPage.img3Fid}'>--%>
						  <%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
						  ...
						  <div class="col-xs-3">
							  <div id="_img3Url"></div>
							  <input id="img3Url" name="img3Url" type="text" class="form-control" value="${dxsActivesDetailsPage.img3Url}" style="display: none">
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  <textarea id="activesStart2" class="form-control" rows="6" name="activesStart2">${dxsActivesDetailsPage.activesStart2}</textarea>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <%--</div>--%>
						  <%--<div class="col-xs-3">--%>
						  <%--<input id="activesId" name="activesId" type="text" class="form-control"  value='${dxsActivesDetailsPage.activesId}'>--%>
						  <%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
						  ...
						  <div class="col-xs-3">
							  <textarea id="recommendedReason" class="form-control" name="recommendedReason" rows="6">${dxsActivesDetailsPage.recommendedReason}</textarea>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
			        ...
			        <%----%>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="createTime" name="createTime" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" value='<fmt:formatDate value='${dxsActivesDetailsPage.createTime}' type="date" pattern="yyyy-MM-dd"/>'>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			        ...
			        <%----%>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="updateTime" name="updateTime" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" value='<fmt:formatDate value='${dxsActivesDetailsPage.updateTime}' type="date" pattern="yyyy-MM-dd"/>'>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			        ...
			        <%----%>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="isDelete" name="isDelete" type="text" class="form-control"  value='${dxsActivesDetailsPage.isDelete}'>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>

...
//				 imageUrl: "E:/upload/",
 ...
 <body>
  ...
  <form id="formobj" action="dxsAidActivesController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="activeStartTime" name="activeStartTime" type="text"   class="form-control" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  type="date" pattern="yyyy-MM-dd"/>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="activeCatelog" name="activeCatelog" type="text" class="form-control"  >--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <div class="col-xs-3">
								<input id="activeNumber" name="activeNumber" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						...
						<label class="Validform_label" style="display: none">图片地址</label>
								...
								<div class="col-xs-3">
									<textarea id="activeIntroduce" name="activeIntroduce" rows="6" class="form-control"></textarea>
								</div>
									</div>
			          <%--<div class="col-xs-3 text-center">--%>
			          	<%--<b>创建时间：</b>--%>
...
$(function() {
    $("#formobj").Validform({
		...
		beforeSubmit: function(curform) {
            var tag = true;
			//提交前处理
			if(jQuery("#activeStartTime").val().trim()==""){
				alert("开始时间不能为空");
				tag=false;
				return tag;
			}

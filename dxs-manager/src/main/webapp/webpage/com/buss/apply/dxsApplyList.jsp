...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="dxsApplyList" checkbox="true" fitColumns="false" title="已审奖学金" actionUrl="dxsApplyController.do?datagrid&checkcode=${checkcode}&applyType=${applyType}" idField="id" fit="true" queryMode="group">

...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="dxsApplyList" checkbox="true" fitColumns="false" title="已审助学金" actionUrl="dxsApplyController.do?datagrid&checkcode=${checkcode}&applyType=${applyType}" idField="id" fit="true" queryMode="group">
   ...
   <%--<t:dgToolBar title="编辑" icon="icon-edit" url="dxsApplyController.do?goUpdate" funname="update"></t:dgToolBar>--%>
   <%--<t:dgToolBar title="批量删除"  icon="icon-remove" url="dxsApplyController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>--%>
   <%--<t:dgToolBar title="查看" icon="icon-search" url="dxsApplyController.do?goUpdate" funname="detail"></t:dgToolBar>--%>

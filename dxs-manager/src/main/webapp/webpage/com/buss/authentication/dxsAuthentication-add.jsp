...
//				 imageUrl: "E:/upload/",
 ...
 <body>
  ...
  <form id="formobj" action="dxsAuthenticationController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="teacherTitle" name="teacherTitle" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  <input id="toturType" name="toturType" type="text" class="form-control"  >
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
						  ...
						  <div class="col-xs-3">
							  <input id="toturSkill" name="toturSkill" type="text" class="form-control"  >
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  <input id="displayVideoUrl" name="displayVideoUrl" type="text" class="form-control"  >
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
						  ...
						  <div class="col-xs-3">
							  <input id="authenticationCount" name="authenticationCount" type="text" class="form-control"  >
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <%--<div class="col-xs-3">--%>
						  <%--<div id="_certificateId"></div>--%>
								<%--<input id="certificateId" name="certificateId" type="text" class="form-control" value="" style="display: none" >--%>
								<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
								<%--<label class="Validform_label" style="display: none">学生证/资格证扫描件</label>--%>
			          <%--</div>--%>
							<%--</div>--%>
								<%--<div class="row show-grid">--%>
			          <%--<div class="col-xs-3 text-center">--%>
			        ...
			        <%----%>
					  ...
					  <%--<div class="row show-grid">--%>
						  ...
						  <%--<div class="col-xs-3">--%>
							  ...
							  <%--<input id="resumeId" name="resumeId" type="text" class="form-control"  value="" style="display: none">--%>
							  <%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
					  ...
					  <%--<div class="row show-grid">--%>
						  ...
						  <%--<div class="col-xs-3">--%>
							  <%--<div id="_workId"></div>--%>
							  <%--<input id="workId" name="workId" type="text" class="form-control"  value="" style="display: none">--%>
							  <%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>

...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="dxsAuthenticationList" checkbox="true" fitColumns="false" title="dxs_authentication" actionUrl="nodxsAuthenticationController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="dxsAuthenticationController.do?doDel&id={id}" />
      <t:dgConfOpt message="确认审核通过？" title="同意" url="nodxsAuthenticationController.do?doType&id={id}&tongyi=1" />
      <t:dgConfOpt   message="确认审核失败？" title="拒绝" url="nodxsAuthenticationController.do?doType&id={id}&tongyi=2" />

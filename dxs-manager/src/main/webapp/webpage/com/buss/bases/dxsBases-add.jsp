...
//				 imageUrl: "E:/upload/",
 ...
 <body>
  ...
  <form id="formobj" action="dxsBasesController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="baseName" name="baseName" type="text" class="form-control"  >
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="baseImgFid" name="baseImgFid" type="text" class="form-control"  >--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>基地缩图地址：</b>
								...
								<div class="col-xs-3">
									...
									<input id="baseImgUrl" name="baseImgUrl" type="text" class="form-control" value="" style="display: none">
									<span class="Validform_checktip" style="float:left;height:0px;"></span>
									<label class="Validform_label" style="display: none">基地缩图地址</label>
								</div>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="baseVideoFid" name="baseVideoFid" type="text" class="form-control"  >--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>视频播放地址：</b>
								...
								<div class="col-xs-3">
									<input id="baseVideoUrl" name="baseVideoUrl" type="text" class="form-control" value="">
									<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="baseUnitName" name="baseUnitName" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3" >
						  <select  name="baseClass" class="form-control" >
							  <option  value="4">国家级</option>
							  <option  value="3">省级</option>
							  <option  value="2">市级</option>
							  <option  value="1">县级 </option>
						  </select>
								<%--<input id="baseClass" name="baseClass" type="text" class="form-control"  >--%>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						  ...
						  <input id="diZhi" class="form-control" type="text" value="请输入详细地址" onfocus="if (value =='请输入详细地址'){value =''}" onblur="if (value ==''){value='请输入详细地址'}"/>
								<input id="baseAddress" name="baseAddress" type="hidden" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

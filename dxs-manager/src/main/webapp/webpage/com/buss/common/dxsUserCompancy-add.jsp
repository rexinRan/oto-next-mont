...
<head>
 ...
 <body>
  ...
  <form id="formobj" action="dxsUserCompancyController.do?doAdd" name="formobj" method="post">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
						...
						<label class="Validform_label" style="display: none">企业ID</label>
			          </div>
					  ...
					  <div class="row show-grid">
								...
								<div class="col-xs-3">
									<input id="compancyImg" name="compancyImg" type="text" class="form-control"  >
									<span class="Validform_checktip" style="float:left;height:0px;"></span>
									<label class="Validform_label" style="display: none">compancyImg</label>
								</div>
						  </div>
					  <div class="row show-grid">
			          <div class="col-xs-3 text-center">
			          ...
			          <div class="col-xs-3">
								<input id="displayImg" name="displayImg" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="displayVideo" name="displayVideo" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="compancyNum" name="compancyNum" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="compancyPositation" name="compancyPositation" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="compancyIntroduce" name="compancyIntroduce" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="compancyType" name="compancyType" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

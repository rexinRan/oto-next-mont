...
//				$("#activeCatelogImg-queue").css("overflow","hidden").html("<img src=\"" + data + "\" />");
 ...
 <body>
  ...
  <form id="formobj" action="dxsCompetitionController.do?doAdd" name="formobj" method="post">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <%--</div>--%>
						  ...
						  <%--</div>--%>
						  <%--<div class="col-xs-3">--%>
							  <%--<input id="competitionImgId" name="competitionImgId" type="text" class="form-control"  >--%>
							  <%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <div class="col-xs-3">
								<input id="competitionTitle" name="competitionTitle" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="competitionOrganisers" name="competitionOrganisers" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="competitionStartTime" name="competitionStartTime" type="text"   class="form-control" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  type="date" pattern="yyyy-MM-dd"/>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="competitionEndTime" name="competitionEndTime" type="text"   class="form-control" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  type="date" pattern="yyyy-MM-dd"/>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="competitionAreas" name="competitionAreas" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="competitionObject" name="competitionObject" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
						<label class="Validform_label" style="display: none">参赛对象</label>
								...
								<div class="row show-grid">
									...
									<div class="col-xs-3">
										...
										<input id="competitionImgUrl" name="competitionImgUrl" type="text" class="form-control" value="" style="display: none">
										<span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  <textarea id="competitionTopic" class="form-control" rows="6" name="competitionTopic"></textarea>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
...
$(function() {
    $("#formobj").Validform({
		...
		beforeSubmit: function(curform) {
            var tag = true;
			//提交前处理
			if($('#competitionStartTime').val()==""){
				alert("开始时间不能为空");
				tag=false;
				return tag;
			}

			if($('#competitionEndTime').val()==""){
				alert("结束时间不能为空");
				tag=false;
				return tag;
			}

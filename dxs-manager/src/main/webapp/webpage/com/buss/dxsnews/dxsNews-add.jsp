...
//		  imageUrl:"jsp/imageUp.jsp",
 ...
 <form id="formobj" action="dxsNewsController.do?doAdd" name="formobj" method="post">
		 ...
		 <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			 <div class="row form-wrapper">
				 ...
				 <div class="row show-grid">
					 ...
					 <div class="col-xs-3">
						 <input id="newEditor" name="newEditor" type="text"  class="form-control" >
						 <span class="Validform_checktip" style="float:left;height:0px;"></span>
					 ...
					 <div class="col-xs-3">
						 <input id="newPublishTime"  name="newPublishTime" type="text"  class="form-control" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
						 <span class="Validform_checktip" style="float:left;height:0px;"></span>
				 ...
				 <div class="row show-grid">
					 ...
					 <div class="col-xs-3">
						 <input id="newFrom" name="newFrom" type="text"  class="form-control" >
						 <span class="Validform_checktip" style="float:left;height:0px;"></span>
				 ...
				 <%--<div class="row show-grid">--%>
					 ...
					 <%--</div>--%>
					 <%--<div class="col-xs-3">--%>
						 <%--<input id="newPublishYear" name="newPublishYear" type="text" class="form-control"  >--%>
						 <%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
				 ...
				 <div class="row show-grid">
					 ...
					 <div class="col-xs-3">
						 <input id="newIntroduction" name="newIntroduction" type="text" class="form-control"  >
						 <span class="Validform_checktip" style="float:left;height:0px;"></span>
				 ...
				 <%--<div class="row show-grid">--%>
					 ...
					 <%--</div>--%>
					 <%--<div class="col-xs-3">--%>
						 <%--<input id="newSort" name="newSort" type="text"  class="form-control" >--%>
						 <%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
					 <%--</div>--%>
				 <%--</div>--%>
				 <div class="row show-grid">
					 ...
					 <div class="col-xs-3">
						 <input id="newVideoUrl" name="newVideoUrl" type="text" class="form-control"  >
						 <span class="Validform_checktip" style="float:left;height:0px;"></span>
				 ...
				 <div class="row show-grid">
					 ...
					 <div class="col-xs-3">
						 <select name="outSign"  class="form-control" >
				 ...
				 <div class="row show-grid">
					 ...
					 <div class="col-xs-3">
						 ...
						 <input id="newImgUrl" name="newImgUrl" type="text" class="form-control" value="" style="display: none">
						 <span class="Validform_checktip" style="float:left;height:0px;"></span>

...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="dxsEmployedList" checkbox="true" fitColumns="false" title="招聘管理" actionUrl="dxsEmployedController.do?datagrid&degId=${degId}" idField="id" fit="true" queryMode="group">
  ...
  <%-- <t:dgCol title="岗位职责"  field="employedResponsibilities"    queryMode="group"  width="120"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="dxsEmployedController.do?goAdd&degId=${degId}&userId=${userId}" funname="add" height="720" width="1120"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="dxsEmployedController.do?goUpdate" funname="update" height="720" width="1120"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="dxsEmployedController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="dxsEmployedController.do?goUpdate" funname="detail" height="720" width="1120"></t:dgToolBar>
      <t:dgToolBar title="返回" icon="icon-put" url="dxsDirectionalEmploymentGroupsController.do?list" funname="quizList"></t:dgToolBar>

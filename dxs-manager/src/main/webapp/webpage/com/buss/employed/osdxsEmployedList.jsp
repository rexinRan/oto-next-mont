...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="osdxsEmployedList" checkbox="true" fitColumns="false" title="招聘管理" actionUrl="EmployedController.do?datagrid&osId=${osId}" idField="id" fit="true" queryMode="group">
  ...
  <%-- <t:dgCol title="岗位职责"  field="employedResponsibilities"    queryMode="group"  width="120"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="EmployedController.do?goAdd&osId=${osId}" funname="add" height="720" width="1120"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="EmployedController.do?goUpdate" funname="update" height="720" width="1120"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="EmployedController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="EmployedController.do?goUpdate" funname="detail" height="720" width="1120"></t:dgToolBar>
      <t:dgToolBar title="返回" icon="icon-put" url="dxsEmployedOnlineSpecialController.do?list" funname="quizList"></t:dgToolBar>

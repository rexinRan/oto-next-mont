...
<form id="formobj" action="dxsEmployedArticleController.do?doAdd" name="formobj" method="post">
		...
		<div class="con-wrapper" id="con-wrapper1" style="display: block;">
			<div class="row form-wrapper">
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						<input id="emoloyedTitle" name="emoloyedTitle" type="text" class="form-control"  >
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						<input id="emoloyedEditor" name="emoloyedEditor" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						<input id="emoloyedVideoUrl" name="emoloyedVideoUrl" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						<input id="emoloyedFrom" name="emoloyedFrom" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
				...
				<%--<div class="row show-grid">--%>
					...
					<%--</div>--%>
					<%--<div class="col-xs-3">--%>
						<%--<input id="emoloyedPublishTime" name="emoloyedPublishTime" type="text"   class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						<input id="emoloyedSort" name="emoloyedSort" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						...
						<input id="emoloyedImgurl" name="emoloyedImgurl" type="text" class="form-control" value="" style="display: none">
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						<textarea id="emoloyedIntroduction" name="emoloyedIntroduction" rows="6"  class="form-control"></textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

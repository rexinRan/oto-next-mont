...
<form id="formobj" action="dxsEmployedCatalogController.do?doAdd" name="formobj" method="post">
		...
		<div class="con-wrapper" id="con-wrapper1" style="display: block;">
			<div class="row form-wrapper">
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						<input id="employedCatalogName" name="employedCatalogName" type="text" class="form-control"  >
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						...
						<input id="employedImgurl" name="employedImgurl" type="text" class="form-control" value="" style="display: none">
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

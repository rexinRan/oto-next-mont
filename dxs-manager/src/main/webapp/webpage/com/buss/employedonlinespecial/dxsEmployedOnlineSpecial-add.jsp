...
//				$("#activeCatelogImg-queue").css("overflow","hidden").html("<img src=\"" + data + "\" />");
 ...
 <body>
  ...
  <form id="formobj" action="dxsEmployedOnlineSpecialController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="noteUrl" name="noteUrl" type="text" class="form-control"  >--%>
			          ...
			          <div class="col-xs-3">
						  ...
						  <input type="radio" name="isPublic" value="1">否
								<%--<input id="isPublic" name="isPublic" type="text" class="form-control"  >--%>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="row show-grid">
							  ...
							  <div class="col-xs-3">
								  ...
								  <input id="imgBannerUrl" name="imgBannerUrl" type="text" class="form-control" value="" style="display: none">
								  <span class="Validform_checktip" style="float:left;height:0px;"></span>

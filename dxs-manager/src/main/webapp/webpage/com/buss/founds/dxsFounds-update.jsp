...
//				 imageUrl: "E:/upload/",
  ...
  function chk() {
	  var obj = document.getElementsByName('foundIndustry');

	    var objSelect =  $('#foundIndustry').val();
...
//		  if (obj[i].checked) s += obj[i].value + ','; //如果选中，将value添加到变量s中
  ...
  function jieduan() {
	  var obj = document.getElementsByName('foundStage');

	  var objSelect =  $('#foundStage').val();
	  var aa = objSelect.split(",")
	  for(var j = 0; j < aa.length; j++) {
...
//		  if (obj[i].checked) s += obj[i].value + ','; //如果选中，将value添加到变量s中
 ...
 <body>
  ...
  <form id="formobj" action="dxsFoundsController.do?doUpdate" name="formobj" method="post">
			<input type="hidden" id="btn_sub" class="btn_sub"/>
			<input type="hidden" name="id" value='${dxsFoundsPage.id}' >
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="userId" name="userId" type="text" class="form-control"  value='${dxsFoundsPage.userId}'>--%>
			          ...
			          <div class="col-xs-3">
								<input id="foundTitle" name="foundTitle" type="text" class="form-control"  value='${dxsFoundsPage.foundTitle}'>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="foundImgFid" name="foundImgFid" type="text" class="form-control"  value='${dxsFoundsPage.foundImgFid}'>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <div class="col-xs-3">
								<input id="foundUserName" name="foundUserName" type="text" class="form-control"  value='${dxsFoundsPage.foundUserName}'>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-6" id="fuxuan">
								<input id="foundIndustry" type="hidden" class="form-control"  value='${dxsFoundsPage.foundIndustry}'>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-6">
						  ...
						  <input  name='foundStage' type='checkbox' value="D轮" />D轮
								<input id="foundStage"  type="hidden" class="form-control"  value='${dxsFoundsPage.foundStage}'>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="foundNum" name="foundNum" type="text" class="form-control" datatype="n" errormsg="请输入数字类型"  value='${dxsFoundsPage.foundNum}'>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  <input id="foundSummary" name="foundSummary" type="text" class="form-control"  value='${dxsFoundsPage.foundSummary}'>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						  ...
						  <input id="diZhi" class="form-control" type="text" value="请输入详细地址" onfocus="if (value =='请输入详细地址'){value =''}" onblur="if (value ==''){value='请输入详细地址'}"/>
								<input id="schoolRealAddress" name="foundAddress" type="hidden" class="form-control"  value='${dxsFoundsPage.foundAddress}'>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="foundException" name="foundException" type="text" class="form-control"  value='${dxsFoundsPage.foundException}'>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  ...
							  <input id="foundImgUrl" name="foundImgUrl" type="text" class="form-control" value="${dxsFoundsPage.foundImgUrl}" style="display: none">
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="createTime" name="createTime" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" value='<fmt:formatDate value='${dxsFoundsPage.createTime}' type="date" pattern="yyyy-MM-dd"/>'>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			        ...
			        <%----%>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="updateTime" name="updateTime" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" value='<fmt:formatDate value='${dxsFoundsPage.updateTime}' type="date" pattern="yyyy-MM-dd"/>'>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			        ...
			        <%----%>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="isDelete" name="isDelete" type="text" class="form-control"  value='${dxsFoundsPage.isDelete}'>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>

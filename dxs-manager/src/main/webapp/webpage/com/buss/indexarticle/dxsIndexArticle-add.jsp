...
//				$("#activeCatelogImg-queue").css("overflow","hidden").html("<img src=\"" + data + "\" />");
 ...
 <body>
  ...
  <form id="formobj" action="dxsIndexArticleController.do?doAdd" name="formobj" method="post">
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
						...
						<label class="Validform_label" style="display: none">文章标题</label>
						  ...
						  <div class="col-xs-3">
							  <input id="articleSort" name="articleSort" type="text" class="form-control"  >
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="articleEditor" name="articleEditor" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
						<label class="Validform_label" style="display: none">文章编辑人</label>
								...
								<div class="col-xs-3">
									<input id="articleVideoUrl" name="articleVideoUrl" type="text" class="form-control"  >
									<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="articlePublishTime" name="articlePublishTime" type="text" style="width: 150px"  class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>'>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
					  ...
					  <div class="col-xs-3">
						  ...
						  <input id="articleImgUrl" name="articleImgUrl" type="text" class="form-control" value="" style="display: none">
						  <span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="articleIntroduction" name="articleIntroduction" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

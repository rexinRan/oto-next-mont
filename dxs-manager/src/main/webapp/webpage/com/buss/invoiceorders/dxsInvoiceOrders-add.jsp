...
<head>
 ...
 <body>
  ...
  <form id="formobj" action="dxsInvoiceOrdersController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
						  <select name="invoiceId" class="form-control" >
							  <c:forEach items="${dxsInvoicesEntityList}" var="dxsInvoices">
								...
								<%--<input id="invoiceId" name="invoiceId" type="text" class="form-control" datatype="*" >--%>
			          ...
			          <div class="col-xs-3">
								<input id="invoiceValue" name="invoiceValue" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="invoiceLabels" name="invoiceLabels" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="applyTime" name="applyTime" type="text"   class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						  <input type="radio" name="invoiceStatus" value="1">已开发票&nbsp;
						  <input type="radio" name="invoiceStatus" value="0">申请成功&nbsp;
						  <%--<input id="invoiceStatus" name="invoiceStatus" type="text" class="form-control"  >--%>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="logisticsCompany" name="logisticsCompany" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="invoiceOrderNum" name="invoiceOrderNum" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="collectionType" name="collectionType" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

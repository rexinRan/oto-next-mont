...
//          $("#activeCatelogImg-queue").css("overflow","hidden").html("<img src=\"" + data + "\" />");
 ...
 <body>
  ...
  <form id="formobj" action="dxsInvoicesController.do?doAdd" name="formobj" method="post">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  <input id="invoiceHeader" name="invoiceHeader" type="text" class="form-control"  >
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						  <input type="radio" name="issueType" value="0">个人&nbsp;
						  <input type="radio" name="issueType" value="1">企业&nbsp;
						  <%--<input id="issueType" name="issueType" type="text" class="form-control"  >--%>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						  <input type="radio" name="invoiceType" value="0">增值税普通发票&nbsp;
						  <input type="radio" name="invoiceType" value="1">增值税专用发票&nbsp;
								<%--<input id="invoiceType" name="invoiceType" type="text" class="form-control"  >--%>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="taxAccount" name="taxAccount" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="registerPalce" name="registerPalce" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="registerPhone" name="registerPhone" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						  ...
						  <input id="businessLincense" name="businessLincense" type="text" class="form-control" value="" style="display: none" align="center">
						  <%--<input id="businessLincense" name="businessLincense" type="text" class="form-control"  >--%>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						  ...
						  <input id="taxPerson" name="taxPerson" type="text" class="form-control" value="" style="display: none" align="center">
								<%--<input id="taxPerson" name="taxPerson" type="text" class="form-control"  >--%>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						  ...
						  <input id="generalTaxpayer" name="generalTaxpayer" type="text" class="form-control" value="" style="display: none" align="center">
								<%--<input id="generalTaxpayer" name="generalTaxpayer" type="text" class="form-control"  >--%>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

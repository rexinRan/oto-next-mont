...
//           imageUrl: "E:/upload/",
 ...
 <body>
  ...
  <form id="formobj" action="dxsLecturesPersionController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="prosonName" name="prosonName" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="prosonJob" name="prosonJob" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="prosonAddress" name="prosonAddress" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="prosonEdu" name="prosonEdu" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="prosonTopJob" name="prosonTopJob" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="prosonNowJob" name="prosonNowJob" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="prosonNowProject" name="prosonNowProject" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						...
						<label class="Validform_label" style="display: none">类别</label>
								...
								<div class="row show-grid">
									...
									<div class="col-xs-3">
										<input id="prosonStyleVideo" name="prosonStyleVideo" type="text" class="form-control"  >
										<span class="Validform_checktip" style="float:left;height:0px;"></span>
									...
									<div class="col-xs-3">
										<input id="educational" name="educational" type="text" class="form-control"  >
										<span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="col-xs-3">
						  <div id="_imgUrl"></div>
						  <input id="imgUrl"   name="imgUrl" type="hidden" class="form-control"  >
						  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3 text-center" >
							  ...
							  <%--<input id="prosonAccomplishment"  type="text" class="form-control" value="" style="display: none">--%>
							  <input id="prosonAccomplishment"   name="prosonAccomplishment" type="hidden" class="form-control" value="" >

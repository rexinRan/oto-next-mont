...
<head>
 ...
 <body>
  ...
  <form id="formobj" action="dxsMessageUserController.do?doAdd" name="formobj" method="post">
			<input type="hidden" id="btn_sub" class="btn_sub"/>
			
			<div class="tab-wrapper">
			    <!-- tab -->
			    <ul class="nav nav-tabs">
			      <li role="presentation" class="active"><a href="javascript:void(0);">dxs_message_user</a></li>
			    </ul>
			    <!-- tab内容 -->
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
						...
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
						<label class="Validform_label" style="display: none">站内信id</label>
			          </div>
						</div>
			          ...
			          <div class="col-xs-3">
								<input id="readTime" name="readTime" type="text" style="width: 150px"  class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <%--<div class="col-xs-3">--%>
						...
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
						<%--<label class="Validform_label" style="display: none">是否放到回收站(预留)</label>--%>
			          <%--</div>--%>
						<%--</div>--%>
...
<script src = "webpage/com/buss/messageuser/dxsMessageUser.js"></script>		
</html>
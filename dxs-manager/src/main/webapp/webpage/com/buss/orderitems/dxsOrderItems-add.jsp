...
<head>
 ...
 <body>
  ...
  <form id="formobj" action="dxsOrderItemsController.do?doAdd" name="formobj" method="post">
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
						...
						<label class="Validform_label" style="display: none">订单编号</label>
						  ...
						  <div class="col-xs-3">
							  <input id="outCatalog" name="outCatalog" type="text" class="form-control"  >
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="outId" name="outId" type="text" class="form-control"  >--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <div class="col-xs-3">
								<input id="priceShort" name="priceShort" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

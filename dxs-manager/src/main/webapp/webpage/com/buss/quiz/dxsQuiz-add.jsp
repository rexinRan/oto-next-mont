...
<form id="formobj" action="dxsQuizController.do?doAdd" name="formobj" method="post">
		...
		<div class="con-wrapper" id="con-wrapper1" style="display: block;">
			<div class="row form-wrapper">
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						<input id="quizName" name="quizName" type="text" class="form-control"  >
				...
				<div class="row show-grid">
					...
					<div class="col-xs-3">
						<input id="quizEditor" name="quizEditor" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

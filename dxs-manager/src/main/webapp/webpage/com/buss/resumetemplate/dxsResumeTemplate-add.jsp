...
//          $("#activeCatelogImg-queue").css("overflow","hidden").html("<img src=\"" + data + "\" />");
 ...
 <body>
  ...
  <form id="formobj" action="dxsResumeTemplateController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="templateCatelog" name="templateCatelog" type="text" class="form-control"  >--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <div class="col-xs-3">
								<input id="templateUrl" name="templateUrl" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="col-xs-3">
						  ...
						  <input id="bigImgUrl" name="bigImgUrl" type="text" class="form-control" value="" style="display: none" align="center">
						  <span class="Validform_checktip" style="float:left;height:0px;"></span>

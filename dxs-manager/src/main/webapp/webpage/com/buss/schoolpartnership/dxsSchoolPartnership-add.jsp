...
//				$("#activeCatelogImg-queue").css("overflow","hidden").html("<img src=\"" + data + "\" />");
 ...
 <body>
  ...
  <form id="formobj" action="dxsSchoolPartnershipController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <%--</div>--%>
						  ...
						  <div class="row show-grid">
							  ...
							  <div class="col-xs-3">
								  ...
								  <input id="schoolRealAddress" name="schoolRealAddress" type="hidden" class="form-control" value="" >
								  <span class="Validform_checktip" style="float:left;height:0px;"></span>
						  ...
						  <div class="row show-grid">
							  ...
							  <div class="col-xs-3">
								  <input id="schoolNetAddress" name="schoolNetAddress" type="text" class="form-control"  >
								  <span class="Validform_checktip" style="float:left;height:0px;"></span>
						  ...
						  <div class="row show-grid">
							  ...
							  <div class="col-xs-3">
								  <input id="schoolPhone" name="schoolPhone" type="text" class="form-control"  >
								  <span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						  <div id="_logoImg"></div>
						  <input id="logoImg" name="logoImg" type="text" class="form-control" value="" style="display: none">
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
						<label class="Validform_label" style="display: none">学校logo</label>
						  ...
						  <div class="row show-grid">
							  ...
							  <div class="col-xs-3">
								  ...
								  <input id="logoBigImg" name="logoBigImg" type="text" class="form-control" value="" style="display: none">
								  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  ...
							  <input id="schoolScenery" name="schoolScenery" type="text" class="form-control" value="" style="display: none">
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
						  ...
						  <div class="col-xs-3">
							  <input id="schoolVideoUrl" name="schoolVideoUrl" type="text" class="form-control"  >
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>

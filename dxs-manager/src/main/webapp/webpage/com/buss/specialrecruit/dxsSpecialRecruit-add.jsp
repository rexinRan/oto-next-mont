...
//				$("#activeCatelogImg-queue").css("overflow","hidden").html("<img src=\"" + data + "\" />");
 ...
 <body>
  ...
  <form id="formobj" action="dxsSpecialRecruitController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="spSchool" name="spSchool" type="text" class="form-control"  >
			          ...
			          <div class="col-xs-3">
								<input id="spDirection" name="spDirection" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="spJobNum" name="spJobNum" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						  <select name="spEducation" class="form-control">
							  <option value="1">本科</option>
							  <option value="2">硕士</option>
							  <option value="3">博士</option>
						  </select>
								<%--<input id="spEducation" name="spEducation" type="text" class="form-control"  >--%>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  <input id="holdStartTime" name="holdStartTime" type="text"   class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
						  ...
						  <div class="col-xs-3">
							  <input id="holdEndTime" name="holdEndTime" type="text"   class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="holdDatatime" name="holdDatatime" type="text"   class="form-control" />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="holdDate" name="holdDate" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="holdNum" name="holdNum" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
						  ...
						  <input id="diZhi" class="form-control" type="text" value="请输入详细地址" onfocus="if (value =='请输入详细地址'){value =''}" onblur="if (value ==''){value='请输入详细地址'}"/>
								<input id="spAddress" name="spAddress" type="hidden" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-3">
							  ...
							  <input id="spImgurl" name="spImgurl" type="text" class="form-control" value="" style="display: none">
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <%--<div class="row show-grid">--%>
						  ...
						  <%--</div>--%>
						  <%--<div class="col-xs-3">--%>
							  <%--<input id="spImgurlFid" name="spImgurlFid" type="text" class="form-control"  >--%>
							  <%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>

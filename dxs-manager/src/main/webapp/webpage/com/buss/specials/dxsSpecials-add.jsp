...
//				$("#activeCatelogImg-queue").css("overflow","hidden").html("<img src=\"" + data + "\" />");
 ...
 <body>
  ...
  <form id="formobj" action="dxsSpecialsController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
						  <div id="_imgUrl"></div>
								<input id="imgUrl" name="imgUrl" type="text" class="form-control" value="" style="display: none" >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="col-xs-3">
						  <textarea id="volunteerObj" name="volunteerObj" rows="6"  class="form-control"></textarea>
						  <span class="Validform_checktip" style="float:left;height:0px;"></span>
					  ...
					  <div class="row show-grid">
						  ...
						  <div class="col-xs-6">
							  <textarea name="introduce" id="introduce" rows="6" class="form-control"></textarea>
						  </div>
					  </div>

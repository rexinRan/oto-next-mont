...
//          $("#activeCatelogImg-queue").css("overflow","hidden").html("<img src=\"" + data + "\" />");
 ...
 <body>
  ...
  <form id="formobj" action="dxsTrainCourseVideoController.do?doAdd" name="formobj" method="post">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			        ...
			        <%----%>
			          ...
			          <div class="col-xs-3">
								<input id="videoName" name="videoName" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
						<label class="Validform_label" style="display: none">视频名称</label>
						  ...
						  <div class="col-xs-3">
							  <input id="videoHourses" name="videoHourses" type="text" class="form-control"  >
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <%--</div>--%>
								...
								<div class="row show-grid">
									...
									<div class="col-xs-3">
										<%--<input id="isFree" name="isFree" type="text" class="form-control"  >--%>
										<input type="radio" name="isFree" value="1" checked="checked">免费&nbsp;

...
//           imageUrl: "E:/upload/",
 ...
 <body>
  ...
  <form id="formobj" action="dxsTrainOnlineCourseController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="courseMinutesAll" name="courseMinutesAll" type="text" class="form-control"  >--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <div class="col-xs-3">
								<input id="coursePrices" name="coursePrices" type="text" class="form-control" datatype="n" errormsg="请输入数字类型" >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			        ...
			        <%----%>
			          ...
			          <%--</div>--%>
								...
								<%--</div>--%>
								<%--<div class="col-xs-3">--%>
									<%--<textarea id="trainContent" name="trainContent" rows="6" class="form-control"  ></textarea>--%>
									<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<textarea id="courseObj" name="courseObj" rows="6" class="form-control"  ></textarea>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <div class="col-xs-9">
						  <script id="container3" name="trainObj" type="text/plain"  style="width: 800px;min-height:300px;"></script>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<textarea id="courseSpecial" name="courseSpecial" rows="6" class="form-control"  ></textarea>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<textarea id="startClassRule" name="startClassRule" rows="6" class="form-control"  ></textarea>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<textarea id="others" name="others" rows="6" class="form-control"  ></textarea>--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
					  ...
					  <div class="row show-grid">
						  ...
						  <%--<div class="col-xs-3">--%>
						  <%--<input id="courseDir" class="form-control" type="text" name="courseDir">--%>
						  <%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>

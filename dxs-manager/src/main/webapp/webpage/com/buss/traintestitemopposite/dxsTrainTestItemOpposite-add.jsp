...
<head>
 ...
 <body>
  ...
  <form id="formobj" action="dxsTrainTestItemOppositeController.do?doAdd" name="formobj" method="post">
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="just" name="just" type="text" class="form-control" datatype="*1-1" errormsg="请输入一个字符">
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="back" name="back" type="text" class="form-control" datatype="*1-1" errormsg="请输入一个字符" >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

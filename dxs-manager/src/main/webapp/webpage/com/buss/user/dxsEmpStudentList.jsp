...
<div class="easyui-layout" fit="true">
  ...
  <%-- <t:dgCol title="是否删除"  field="isdelete"    queryMode="group"  width="120"></t:dgCol>--%>
   ...
   <%--<t:dgToolBar title="批量审核"  icon="icon-remove" url="dxsUserController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>--%>
      <t:dgToolBar title="编辑" icon="icon-edit" url="dxsUserCompancyController.do?goUpdate" funname="update"  height="720" width="1120"></t:dgToolBar>
      <t:dgToolBar title="查看详情" icon="icon-search" url="dxsUserCompancyController.do?goUpdate" funname="detail"  height="720" width="1120"></t:dgToolBar>
   <%--

...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="dxsUserList" checkbox="true" fitColumns="false" title="用户列表" actionUrl="dxsUserController.do?datagrid&checkstatus=10" idField="id" fit="true" queryMode="group">
  ...
  <%-- <t:dgCol title="密码"  field="pwd"    queryMode="group"  width="120"></t:dgCol>--%>
   ...
   <%--<t:dgCol title="核审状态"  field="checkstatus"    queryMode="group"  width="120" formatterjs="DXS.userCheck" align="center"></t:dgCol>--%>

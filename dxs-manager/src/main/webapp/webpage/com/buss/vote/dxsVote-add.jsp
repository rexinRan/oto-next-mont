...
//				$("#activeCatelogImg-queue").css("overflow","hidden").html("<img src=\"" + data + "\" />");
 ...
 <body>
  ...
  <form id="formobj" action="dxsVoteController.do?doAdd" name="formobj" method="post">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			        ...
			        <%----%>
			          ...
			          <%--</div>--%>
			          <%--<div class="col-xs-3">--%>
								<%--<input id="voteId" name="voteId" type="text" class="form-control"  >--%>
						<%--<span class="Validform_checktip" style="float:left;height:0px;"></span>--%>
			          ...
			          <div class="col-xs-3">
								<input id="voteTitle" name="voteTitle" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="deadlineDate" name="deadlineDate" type="text"   class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="voteStateTime" name="voteStateTime" type="text"  class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="voteEndTime" name="voteEndTime" type="text"   class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="voteUsertypeId" name="voteUsertypeId" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="voteNum" name="voteNum" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <%--</div>--%>
						  ...
						  <div class="col-xs-3">
							  <input id="voteAddress" name="voteAddress" type="text" class="form-control"  >
							  <span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="publishTime" name="publishTime" type="text"   class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					...
					<div class="row show-grid">
								...
								<div class="col-xs-3">
									...
									<input id="voteImage" name="voteImage" type="text" class="form-control" value="" style="display: none">
					...
					<div class="row show-grid">
								...
								<div class="col-xs-9">
									<!-- 加载编辑器的容器 -->
									<script id="container" name="voteIntroduce" type="text/plain"  style="width: 800px;min-height:300px;"></script>
								</div>
                            </div>
					<div class="row show-grid">
						<div class="col-xs-3 text-center">
						...
						<div class="col-xs-9">
							<!-- 加载编辑器的容器 -->
							<script id="_container" name="voteRule" type="text/plain"  style="width: 800px;min-height:300px;"></script>
						</div>
					</div>
...
$(function() {
    $("#formobj").Validform({
		...
		beforeSubmit: function(curform) {
            var tag = true;
			//提交前处理
			if(jQuery("#voteStateTime").val().trim()==""){
				alert("开始时间不能为空");
				tag=flag;
			}
			if(jQuery("#voteEndTime").val().trim()==""){
				alert("结束时间不能为空");
				tag=flag;
			}

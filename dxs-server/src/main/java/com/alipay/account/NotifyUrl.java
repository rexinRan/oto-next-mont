...
public class NotifyUrl {
    ...
    @RequestMapping(value = "notifyUrlInfo.do")
    @ResponseBody
    public ReplyDataMode notifyUrlInfo(HttpServletRequest request, HttpServletResponse response){
...
//                out.write("success".getBytes("UTF-8"));
                    ...
                    replyDataMode.setStatusCode("success:Notify_Url");
...
//                out.write("fail".getBytes("UTF-8"));
                    ...
                    replyDataMode.setStatusCode("fail:Notify_Url");

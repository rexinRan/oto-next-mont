package com.buss.accountlogin.entity;
...
/**   
 * @Title: Entity
 * @Description: dxs_account_log_in
 * @author onlineGenerator
 * @date 2016-09-22 10:30:29
 * @version V1.0   
 *
 */
@Entity
@Table(name = "dxs_account_log_in", schema = "")
@SuppressWarnings("serial")
public class AccountLogInEntity implements java.io.Serializable {
	/**主键*/

package com.buss.activescustomcourses.entity;
...
/**   
 * @Title: Entity
 * @Description: dxs_actives_custom_courses
 * @author onlineGenerator
 * @date 2016-08-01 09:38:24
 * @version V1.0   
 *
 */
@Entity
@Table(name = "dxs_actives_custom_courses", schema = "")
@SuppressWarnings("serial")
public class ActivesCustomCoursesEntity implements java.io.Serializable {
	/**主键*/
	private java.lang.String id;
	/**课程名*/
	private java.lang.String courses;
	/**价格*/
	private java.lang.Integer prices;
	/**是否可用*/
	 ...
	 */
	@Column(name ="COURSES",nullable=true,length=200)
	 ...
	 */
	@Column(name ="PRICES",nullable=true,length=10)
	 ...
	 */
	public void setPrices(java.lang.Integer prices){
		this.prices = prices;
	}
	/**
	 *方法: 取得java.lang.Integer

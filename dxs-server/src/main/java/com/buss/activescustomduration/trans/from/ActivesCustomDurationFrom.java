package com.buss.activescustomduration.trans.from;
 ...
 */
@Mapping(entityClass = ActivesCustomDurationEntity.class)
public class ActivesCustomDurationFrom extends SearchForm{
    /**id*/
    @Mapping

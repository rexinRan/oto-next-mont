package com.buss.activescustommode.entity;
...
/**   
 * @Title: Entity
 * @Description: dxs_actives_custom_mode
 * @author onlineGenerator
 * @date 2016-08-01 09:37:51
 * @version V1.0   
 *
 */
@Entity
@Table(name = "dxs_actives_custom_mode", schema = "")
@SuppressWarnings("serial")
public class ActivesCustomModeEntity implements java.io.Serializable {
	/**主键*/

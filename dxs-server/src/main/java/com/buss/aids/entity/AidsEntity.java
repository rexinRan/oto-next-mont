...
import com.buss.aidcatelog.entity.AidCatelogEntity;
...
public class AidsEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**扶贫分类id*/
	...
	/**精准扶贫分类*/
	private AidCatelogEntity aidCatelog;

	@ManyToOne()
	@JoinColumn(name="AID_CATELOG_ID",insertable = false, updatable = false)
	public AidCatelogEntity getAidCatelog() {
		return aidCatelog;
	}

	public void setAidCatelog(AidCatelogEntity aidCatelog) {
		this.aidCatelog = aidCatelog;
	}

package com.buss.aids.trans.form;
...
public class AidsSearchForm extends SearchForm {
    /**主键*/
    @Mapping
    private String id;
    /**扶贫分类id*/
    ...
    /**扶贫分类id*/
    @Mapping("aidCatelog.aidCatelogName")
    private String aidCatelogName;
    /**扶贫分类id*/
    @Mapping("aidCatelog.pid")
    private String pid;
    /**扶贫标题*/
    @Mapping

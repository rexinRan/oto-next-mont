 ...
 */
@Entity
@Table(name = "hx_active_detail", catalog = "hxclub")
public class HxActiveDetail implements java.io.Serializable {
	...
	public HxActiveDetail() {
	}

	public HxActiveDetail(long id) {
		this.id = id;
	}

	public HxActiveDetail(long id, String content, Long count, Date createTime, Date updateTime) {
		this.id = id;

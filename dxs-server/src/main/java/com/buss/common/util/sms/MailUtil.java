...
public class MailUtil {
	...
	public static void main(String[] args) {
		try {
//			sendEmail("smtp.163.com", "376250781@qq.com", "系统测试邮件", 
//					"hi,all,I am AnChao!111", "pwu@hongxinguoji.com", 
//					"pwu@hongxinguoji.com", "Qq376250");
			
			PropertiesUtil util = new PropertiesUtil("sysConfig.properties");
			sendEmail(util.readProperty("mail.smtpHost"), "yangzhiguo07@163.com","系统测试邮件",

 ...
 */
@Entity
@Table(name = "dxs_competition", schema = "dxsdb")
public class CompetitionEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**用户id*/
	 ...
	 */
	@Column(name ="COMPETITION_INTRODUCE",nullable=true,length=16777215)
	 ...
	 */
	@Column(name ="COMPETITION_RULE",nullable=true,length=16777215)

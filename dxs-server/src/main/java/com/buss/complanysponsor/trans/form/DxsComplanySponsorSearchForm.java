...
public class DxsComplanySponsorSearchForm extends SearchForm {
    /**主键*/
    @Mapping
    private String id;
    /**申请人的ID*/
    ...
    /**营业执照编号*/
    @Mapping
    private String complanyLicenseNum;
    /**身份证号*/
    @Mapping
    ...
    public String getComplanyLicenseNum() {
        return complanyLicenseNum;
    }

    public void setComplanyLicenseNum(String complanyLicenseNum) {

package com.buss.entrepreneurshipprojectcompetition.trans.form;
...
public class EntrepreneurshipProjectCompetitionSearchForm extends SearchForm{
    /**主键*/
    @Mapping
    private String id;
    /**项目所属领域id*/
    ...
    public EntrepreneurshipProjectCompetitionSearchForm() {
    }

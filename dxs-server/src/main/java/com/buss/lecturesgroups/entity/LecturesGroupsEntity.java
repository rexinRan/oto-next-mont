package com.buss.lecturesgroups.entity;
 ...
 */
@Entity
@Table(name = "dxs_lectures_groups", schema = "")
@SuppressWarnings("serial")
public class LecturesGroupsEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="SUMMY",nullable=true,length=255)
	 ...
	 */
	public void setSummy(java.lang.String summy){
		this.summy = summy;
	}
	/**
	 *方法: 取得java.lang.String

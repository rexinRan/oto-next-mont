package com.buss.resume.resumetemplate.entity;
...
public class ResumeTemplateEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**模板名称*/

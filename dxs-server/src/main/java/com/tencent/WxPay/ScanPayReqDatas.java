...
/**
 * 统一下单(必填项)
 * Created by HongXinGuoJi-yzg on
 */
public class ScanPayReqDatas {
     ...
     */
    public ScanPayReqDatas(String body,String attach,String outTradeNo,int totalFee,String spbillCreateIp,
                          String productId,String timeStart,String timeExpire){

...
<body>
    <div class="header">
        ...
        <div class="container blue">
            <div class="title">全国大学生创业就业中心!</div>
        </div>
    </div>
    <div class="content">
        <form action="http://www.csee-china.com/dxs-server/alipayapi/submitOrderDefrayal.do" class="alipayform" method="POST" target="_blank">
